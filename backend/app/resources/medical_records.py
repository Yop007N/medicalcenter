...
def list_medical_records():
    ...
    # Eagerly load files to prevent N+1 queries during serialization
    records = query.options(selectinload(MedicalRecord.files)).order_by(db.desc(MedicalRecord.record_date)).all()
