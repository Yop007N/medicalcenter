...
def get_patient_medical_history(patient_id):
    ...
    # Get all medical records ordered by date with files eagerly loaded
    records = (
        patient.medical_records.options(subqueryload(MedicalRecord.files))
        .order_by(db.desc("record_date"))
        .all()
    )
...
def get_patient_medical_records(patient_id):
    ...
    records = (
        ...
        .options(subqueryload(MedicalRecord.files))
...
def get_patient_budgets(patient_id):
    ...
    budgets = (
        Budget.query.filter_by(patient_id=patient_id)
