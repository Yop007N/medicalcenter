...
class TestListUsers:
    ...
    def test_list_users_with_pagination(self, client, admin_auth_headers, admin_user):
        """Test user listing with pagination (Admin only)"""
    ...
    def test_list_users_forbidden(self, client, auth_headers):
        """Test user listing with non-admin user (Professional)"""
...
class TestGetUser:
    ...
    def test_get_user_success(self, client, admin_auth_headers, admin_user):
        """Test successful user retrieval (Admin)"""
    ...
    def test_get_user_forbidden(self, client, auth_headers, admin_user):
         """Test get user with non-admin user accessing another user"""
         # Professional trying to access Admin profile
...
class TestUpdateUser:
    ...
    def test_update_user_success(self, client, admin_auth_headers, admin_user):
        """Test successful user update (Admin updates self)"""
...
class TestDeleteUser:
    ...
    def test_delete_user_forbidden(self, client, auth_headers, patient_user):
        """Test user deletion with non-admin user"""
