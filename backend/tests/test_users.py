...
class TestListUsers:
    ...
    def test_list_users_success(self, client, auth_headers, admin_user):
    ...
    def test_list_users_with_pagination(self, client, auth_headers, admin_user):
...
class TestGetUser:
    ...
    def test_get_user_success(self, client, auth_headers, admin_user):
