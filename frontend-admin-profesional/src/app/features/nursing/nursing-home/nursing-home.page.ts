...
@Component({
  ...
  template: `
    <ion-content class="ion-padding">
      <ion-card>
        <ion-card-header>
          <ion-card-title>Módulo de Enfermería</ion-card-title>
        </ion-card-header>
        <ion-card-content>
          Flujo clínico especializado para enfermería.
        </ion-card-content>
      </ion-card>

      <ion-list>
        <ion-item routerLink="/nursing/workspace" detail>
          <ion-label>
            <h2>Panel clínico de Enfermería</h2>
      ...
      <ion-button expand="block" routerLink="/nursing/workspace" class="ion-margin-top">
        Abrir módulo de Enfermería
      </ion-button>
    </ion-content>
  `,
})
export class NursingHomePage {}
