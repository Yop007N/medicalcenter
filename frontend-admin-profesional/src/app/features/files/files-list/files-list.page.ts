              ...
              <ion-list>
                @for (file of group.files; track file.id) {
                  <ion-item>
                    ...
                    <ion-button aria-label="Descargar archivo" fill="clear" size="small" slot="end" (click)="download(file)">
                      <ion-icon name="download-outline"></ion-icon>
                    </ion-button>
                    <ion-button aria-label="Eliminar archivo" fill="clear" size="small" color="danger" slot="end" (click)="remove(file)">
