      ...
      <ion-toolbar>
        ...
        <ion-buttons slot="end">
          @if (professional$ | async; as professional) {
            <!-- Mobile: solo iconos -->
            <ion-button aria-label="Editar profesional" [routerLink]="['/professionals', professional.id, 'edit']" class="hide-desktop">
              <ion-icon slot="icon-only" name="create-outline"></ion-icon>
            </ion-button>
            <ion-button aria-label="Eliminar profesional" color="danger" (click)="confirmDelete(professional)" class="hide-desktop">
