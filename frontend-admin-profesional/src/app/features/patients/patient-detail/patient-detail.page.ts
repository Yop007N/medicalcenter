      ...
      <ion-toolbar>
        ...
        <ion-buttons slot="end">
          @if (patient$ | async; as patient) {
            <!-- Mobile: solo iconos -->
            <ion-button aria-label="Editar" [routerLink]="['/patients', patient.id, 'edit']" [queryParams]="moduleQueryParams" class="hide-desktop">
              <ion-icon slot="icon-only" name="create-outline"></ion-icon>
            </ion-button>
            <ion-button aria-label="Eliminar" color="danger" (click)="confirmDelete(patient)" class="hide-desktop">
