      ...
      <ion-toolbar>
        ...
        <ion-buttons slot="end">
          @if (treatment$ | async; as treatment) {
            <!-- Mobile: solo iconos -->
            <ion-button [routerLink]="['/odontology/treatments', treatment.id, 'edit']" class="hide-desktop" aria-label="Editar tratamiento">
              <ion-icon slot="icon-only" name="create-outline"></ion-icon>
            </ion-button>
            <ion-button color="danger" (click)="confirmDelete(treatment)" class="hide-desktop" aria-label="Eliminar tratamiento">
