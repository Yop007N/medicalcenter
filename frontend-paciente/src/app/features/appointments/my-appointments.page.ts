      ...
      <section class="panel">
        ...
        <div class="item-actions">
          <ion-button size="small" (click)="createAppointment()" [disabled]="!canCreateAppointment() || booking">
            @if (booking) { <ion-spinner name="crescent"></ion-spinner> Solicitando... } @else { Solicitar turno }
          </ion-button>
          @if (!canCreateAppointment() && !booking) {
            <p class="panel-text">Selecciona profesional y horario libre para continuar.</p>
          }
        </div>
      </section>
              ...
              <ion-label>
                ...
                <div class="item-actions">
                  ...
                  @if (canCancel(appointment)) {
                    ...
                    >
                      @if (cancellingIds.has(appointment.id)) { <ion-spinner name="crescent"></ion-spinner> Cancelando... } @else { Cancelar }
                    </ion-button>
                  }
                </div>
              </ion-label>
